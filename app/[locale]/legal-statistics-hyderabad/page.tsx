...
const STAT_CATEGORIES: StatCategory[] = [
  {
    ...
    stats: [
      ...
      },
      {
        figure: "~76 %",
        label:
          "Share of cyber crime complaints relating to financial fraud (national average)",
        source: "NCRB — Crime in India 2022, Chapter 19",
        note:
          "Fraudulent OTP collection, investment scams, banking-credential phishing and KYC fraud are the dominant categories.",
      },
      {
        figure: "1930",
  ...
  },
  {
    ...
    description:
      "Section 138 Negotiable Instruments Act cases are among the most numerically significant matters before Metropolitan Magistrates in Hyderabad. Pendency remains high across India.",
    stats: [
      {
        figure: "~35 lakh",
        label:
        ...
        source:
          "Supreme Court — In Re: Expeditious Trial of Cases (2021), reaffirmed 2023",
        note:
      ...
      },
      {
        figure: "30 days",
        label:
          "Statutory notice period before a Section 138 complaint can be filed",
        source:
          "Section 138 read with Section 142, Negotiable Instruments Act 1881",
        note:
      ...
      },
      {
        figure: "2 years",
        label:
          "Prescribed maximum imprisonment on conviction (or fine or both)",
        source:
          "Section 138, Negotiable Instruments Act 1881 (as amended 2018)",
      },
    ],
  },
  {
    ...
    description:
      "Property litigation constitutes a significant share of civil court pendency in Telangana. Matters typically traverse civil courts, the High Court, the revenue Tahsildar and, in some cases, TSRERA.",
    stats: [
      {
        figure: "~4.5 crore",
      ...
      },
      {
        ...
        label:
          "Typical first listing to evidence stage in a civil property suit in Hyderabad",
        source:
          "GS Law Firm practice observation; consistent with NJDG district-wise disposal data",
        note:
          "Timelines vary by complexity of title chain, number of defendants, interim relief applications and prevailing court roster.",
      },
      {
        figure: "TSRERA",
        label:
          "Telangana Real Estate Regulatory Authority — separate forum for RERA complaints",
        source: "TSRERA — tsrera.telangana.gov.in",
        note:
          "Builder delays, possession defaults and title issues under RERA are adjudicated separately from civil courts.",
      },
    ],
  },
  {
    ...
    slug: "consumer-forum",
    description:
      "Consumer disputes are handled by a three-tier system: District CDRC, State CDRC (TSCDRC) and NCDRC. Filing thresholds were substantially revised by the Consumer Protection Act 2019.",
    stats: [
      {
        figure: "₹50 lakh",
      ...
      },
      {
        figure: "5,82,544",
        label:
          "Cases pending before all consumer commissions in India (2022)",
      ...
      },
      {
        ...
        note:
          "Admission does not guarantee success. The opposite party must be heard before a final order.",
      },
    ],
  },
  {
    ...
    description:
      "Hyderabad is served by the Hyderabad, Cyberabad and Rachakonda Commissionerates. Criminal cases travel through Magistrate courts before session-stage matters proceed to the Sessions Court.",
    stats: [
      {
        figure: "2,83,748",
      ...
      },
      {
        figure: "~60 %",
        label:
          "Share of IPC crimes related to property and economic offences in Telangana",
        source: "NCRB — Crime in India 2022, Chapter 1",
        note:
          "Theft, cheating, criminal breach of trust and misappropriation combine to form the largest share.",
      },
      {
        figure: "24 hours",
        label:
          "Maximum police custody before production before a Magistrate (on arrest without warrant)",
        source:
          "Section 57, CrPC 1973 / Section 35, BNSS 2023",
        note:
          "The Magistrate may order further custody on application; bail applications may be filed at this stage.",
      },
      {
        figure: "1 July 2024",
        label:
          "Date Bharatiya Nagarik Suraksha Sanhita (BNSS) replaced the CrPC",
        source: "Ministry of Home Affairs notification",
        note:
          "FIR filing, time-bound investigation, trial timelines and bail grounds have all changed. If your matter began before this date, transitional provisions may apply.",
      },
    ],
  },
];
...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "The National Judicial Data Grid (njdg.ecourts.gov.in) provides free public access to case status, pendency and disposal data for district courts across India including Telangana. The High Court of Telangana's own e-filing portal also carries cause-list and order data.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Depending on the relief sought and the parties, property matters may fall before: the Civil Court (Junior or Senior Civil Judge), the City Civil Court, or the High Court of Telangana for higher-value or writ matters. Revenue tribunals and TSRERA are parallel forums for specific categories.",
  },
  {
    question:
      ...
      <section className="pd-body">
        ...
        <aside className="pd-side" aria-label="Related actions and links">
          <div className="pd-cta">
            ...
            <p>
              Statistics give context; an advocate can assess the specifics —
              documents, deadlines, opposing parties and applicable procedure.
            </p>
