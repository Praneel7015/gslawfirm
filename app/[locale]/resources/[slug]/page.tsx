...
// ── Article content ────────────────────────────────────────────────────────
// Each article is self-contained in this file.  When the article list grows
// beyond 6-8 entries it is worth splitting content into
// content/resource-articles/<slug>.ts files and importing them here.
...
const ARTICLE_CONTENT: Record<string, ArticleData> = {
  "what-to-do-after-receiving-legal-notice-hyderabad": {
    ...
    sections: [
      {
        heading: "Step 1 — Read the notice in full without panicking",
      ...
      {
        heading: "Step 2 — Identify the legal basis of the claim",
      ...
      {
        heading: "Step 3 — Check the deadline",
      ...
      {
        heading: "Step 4 — Do not reply without legal advice in most cases",
        body: "An emotional or hasty reply can inadvertently admit facts, waive defences or create a paper trail that works against you. At the same time, a bare 'noted' reply that denies everything without substance rarely helps either. For notices involving money claims above ₹50,000, property, employment, NI Act, or any criminal allegation, consult an advocate before sending any reply.",
      },
      {
        heading: "Step 5 — Gather your documents",
        body: "Before speaking to an advocate, collect every document relevant to the subject: the original contract or agreement, payment receipts or bank statements, any prior correspondence (letters, emails, WhatsApp messages), delivery proofs, invoices, photographs, or any government record involved. The quality of your response often depends on what you can prove.",
        items: [
      ...
      {
        heading: "Step 6 — Draft and send a considered reply",
        body: "A good reply to a legal notice states the facts clearly, refers to the relevant documents, denies unsubstantiated allegations specifically (not generally), and is proportionate in tone. It should not threaten or make admissions. It should be sent by registered post (AD) or speed-post and a copy retained. The date of posting matters.",
      },
      {
        heading: "When you can safely ignore a legal notice",
    ...
    howToSteps: [
      ...
      },
      {
        ...
        text: "Calculate any response window mentioned. For Section 138 NI Act notices, the payment deadline is 15 days from the date of receipt of the notice.",
      },
      {
  ...
  "understanding-bail-in-hyderabad-courts": {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Regular bail is sought after a person has been arrested. If the police have taken custody, an application is first made before the Magistrate (for bailable or non-bailable offences at the Magistrate stage). For serious offences triable by Sessions Court, bail may be sought from the Sessions Court under Section 439 CrPC (now Section 483 BNSS). In Hyderabad, regular bail applications are typically heard at City Criminal Court (CCC) or the relevant Magistrate Court, with Sessions matters at the City Sessions Court.",
        items: [
          "FIR copy and charge sheet (if filed)",
          "Arrest memo",
          "Custody remand papers",
      ...
      },
      {
        ...
        body: "Anticipatory bail is sought by a person who reasonably apprehends arrest. It is a pre-arrest remedy. The High Court or Sessions Court can grant anticipatory bail — it cannot be granted by a Magistrate. In Hyderabad, anticipatory bail applications before the High Court of Telangana are heard at the High Court's criminal side. The court considers the nature of the offence, the applicant's criminal antecedents, the possibility of flight, and whether the application is being used to obstruct investigation.",
      },
      {
        heading: "Interim bail — temporary relief while main application is pending",
        body: "When a regular bail or anticipatory bail application is pending and the matter cannot be heard urgently, courts may grant interim bail — a temporary release for a short fixed period. This is discretionary and is not an entitlement. In practice, it is used when the accused's health, family circumstances or other pressing reasons justify brief release.",
      },
      {
        heading: "How courts decide bail in Hyderabad — key factors",
        body: "Section 439 CrPC (now Section 483 BNSS) and the Supreme Court's guidelines in Satender Kumar Antil v. CBI (2022) require courts to weigh specific factors. Understanding these factors helps in preparing a bail application that addresses what the court will actually look at.",
        items: [
      ...
      },
      {
        ...
        body: "The Bharatiya Nagarik Suraksha Sanhita 2023 (which replaced the Code of Criminal Procedure) came into force on 1 July 2024. Several bail provisions have changed: mandatory bail provisions for half-time served (Section 479 BNSS), time-bound investigation requirements, and an obligation to hear bail applications within fixed periods. If your matter began before July 2024, the transitional position under the BNSS may apply — your advocate should advise on which procedural code governs your specific matter.",
      },
    ],
    howToSteps: [
      {
        name: "Determine the stage — arrest or apprehended arrest",
        text: "If an arrest has already happened, you need regular bail (Section 437 or 439 CrPC/BNSS). If you apprehend arrest, seek anticipatory bail (Section 438 CrPC/BNSS) from the High Court or Sessions Court.",
      },
      {
        name: "Identify the correct court",
        text: "For bailable offences — any Magistrate can grant bail. For non-bailable offences — Magistrate first, Sessions Court for superior relief. Anticipatory bail — only Sessions Court or High Court.",
      },
      {
        name: "Collect documents before approaching an advocate",
        text: "Gather the FIR, arrest memo, remand papers, charge sheet (if filed), surety details and identity proofs. The faster these are available, the faster the application can be filed.",
      },
      {
        name: "Brief an advocate on the factual background",
        text: "Give a candid account of the facts. The advocate needs to know the allegations, your relationship with the complainant, any prior cases, and your personal circumstances to frame the application correctly.",
      },
      {
        name: "File and attend the hearing",
        text: "The advocate files the bail application and fixes a hearing date. In Hyderabad courts, first hearings on bail applications are usually within 2–7 working days for Magistrate matters and similar for Sessions Court depending on roster.",
      },
    ],
    closingNote:
      "Bail timing matters. In serious offence cases where the police have opposed bail or an earlier application was rejected, an appeal to the High Court may be the next step. If you have an urgent bail matter in Hyderabad, call the firm directly at +91 99638 47704 — bail applications are time-sensitive and cannot wait for an email exchange.",
  },

  "property-title-verification-hyderabad": {
    intro:
      "Purchasing property in Hyderabad is one of the most significant financial decisions most people make. Yet property title verification is often treated as a formality rather than a substantive exercise. Title defects — gaps in the chain of ownership, undisclosed encumbrances, forged documents — surface years after a purchase and can result in litigation that is far more expensive than the verification would have been.",
    sections: [
      {
        heading: "What title verification means in Hyderabad",
        body: "Title verification is the process of confirming that the person selling property actually owns it, that no third party has a prior or superior claim, that the property is free of encumbrances (loans, mortgages, attachments), and that all revenue records are consistent with the title documents. In Telangana, this involves reviewing records from the Sub-Registrar's office, the Dharani portal (for registered land), and local government records.",
      },
      {
        heading: "Documents reviewed in a typical title search",
        body: "The exact documents depend on whether the property is an apartment, an agricultural land parcel or a plot in a layout. A typical residential title search in Hyderabad looks at the following:",
        items: [
          "Sale deeds for the last 30 years (or more for agricultural land) — the chain of title",
          "Encumbrance Certificate (EC) from the Sub-Registrar's office — shows all registered transactions on the property",
          "Pahani/Adangal records and Record of Rights (ROR) — Telangana Dharani portal for agricultural and revenue land",
          ...
          "No-objection certificates from bank (if property was mortgaged and loan discharged)",
        ],
      },
      {
        heading: "What an Encumbrance Certificate (EC) reveals",
        body: "The Encumbrance Certificate from the Sub-Registrar is one of the most important documents in a title search. It lists all registered encumbrances — mortgages, sale agreements, court attachments, lis pendens (notice of pending suit) — for a specified period. In Telangana, the Dharani portal provides EC data for most properties. However, ECs only capture registered transactions. Oral family arrangements, unregistered agreements, or inherited ownership claims will not appear in an EC.",
      },
      {
        heading: "Dharani portal and its limitations",
        body: "Telangana's Dharani integrated land records management system is an important starting point for checking agriculture, BRK (Backward Regulation of Kisans) and some urban land data. However, Dharani has faced well-documented technical and data-entry issues. An advocate familiar with Telangana revenue records can identify inconsistencies, slot errors and mutation gaps that a layperson reviewing Dharani data alone may miss.",
      },
      {
        ...
        items: [
          ...
          "HMDA/GHMC violations — unapproved construction that affects the occupancy certificate",
        ],
      },
      {
    ...
    howToSteps: [
      ...
      },
      {
        ...
        text: "Do not rely solely on the EC provided by the seller. Apply independently at the Sub-Registrar's office or through the Telangana registration portal to get the EC for the survey/plot/door number.",
      },
      {
        name: "Check Dharani portal and revenue records",
        text: "Visit dharani.telangana.gov.in to verify pattadar passbook, mutation history and any pending disputes for agricultural or revenue land. Cross-check with physical survey number.",
      },
      {
      ...
      {
        name: "Brief an advocate for full title opinion",
...
export default async function ResourceArticlePage({
  ...
  return (
    <main id="main">
      ...
      {/* ── HERO ── */}
      <section className="pd-hero resource-article-hero" aria-labelledby="article-title">
        ...
        <p className="stats-caveat">
          <strong>Note:</strong> This guide is general information, not legal
          advice for your specific matter.{" "}
      ...
      {/* ── BODY ── */}
      <section className="pd-body resource-article-body">
        <div className="pd-content">
          ...
          {/* ── Closing ── */}
          <p className="article-closing">{content.closingNote}</p>
